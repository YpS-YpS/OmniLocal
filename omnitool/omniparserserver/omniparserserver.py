...
# With Qwen2.5-VL OCR (for stylized/game fonts):
# python -m omniparserserver --som_model_path ../../weights/icon_detect/model.pt --caption_model_name florence2 --caption_model_path ../../weights/icon_caption_florence --device cuda --BOX_TRESHOLD 0.05 --IOU_THRESHOLD 0.1 --use_qwen_ocr
'''
...
def parse_arguments():
    ...
    parser.add_argument('--use_qwen_ocr', action='store_true', help='Use Qwen2.5-VL-2B for OCR recognition (PaddleOCR detection + Qwen recognition)')
    parser.add_argument('--qwen_model_path', type=str, default='Qwen/Qwen2.5-VL-3B-Instruct', help='Path to Qwen2.5-VL model (HuggingFace ID or local path)')
...
class ParseRequest(BaseModel):
    ...
    use_qwen_ocr: Optional[bool] = None   # True = Qwen2.5-VL recognition (overrides PaddleOCR/EasyOCR)
