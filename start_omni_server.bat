...
echo   1. PaddleOCR (default - standard text)
echo   2. EasyOCR
echo   3. Qwen2.5-VL (best for stylized/game fonts - uses ~4-6GB extra VRAM)
echo.
...
if "%OCR_CHOICE%"=="1" (
    ...
    set "OCR_FLAG=--use_qwen_ocr"
    set "OCR_NAME=Qwen2.5-VL"
) else (
    set "OCR_FLAG="
